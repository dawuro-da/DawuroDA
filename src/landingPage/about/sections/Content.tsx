  ...
  return (
    <>
      <div className="relative lg:mt-[130px] mt-[100px] h-max">
        <div className="relative w-full xl:lg:h-[90%] md:h-[90%] h-[30%] min-h-[200px] xl:lg:min-h-[400px] md:min-h-[400px] bg-[url('/aboutus.webp')] bg-cover bg-center bg-no-repeat">
