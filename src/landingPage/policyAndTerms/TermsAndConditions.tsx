    ...
    <I18nextProvider i18n={i18n}>
      <div>
        ...
        <div className="xl:lg:px-40 md:px-20 px-10 w-full my-12 text-[rgb(0,0,0,0.6)]">
          ...
          <p>
            {`Our website has been created by the DawuroDA and the whole of its contents, including texts, still or moving images, data bases, programmes, etc., may be protected by intellectual property rights, including copyright. Unless otherwise indicated, all intellectual property rights relating to our website are the DawuroDA’s exclusive property. You are free to share, copy and redistribute all or part of our website for non-commercial use only, provided that (a) no changes are made, (b) the source is acknowledged and (c) you do not suggest that the DawuroDA.`}
          </p>
          <br />
          ...
          <p>
            {`With in the framework of the collection and processing of personal data, the DawuroDA is bound by Ethiopian legislation on data protection. For further information, please consult our Privacy Policy.`}
          </p>
          <br />
